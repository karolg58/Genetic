...
namespace GeneticSharp.Domain.Crossovers
{
    ...
    public class CutAndSpliceEmasCrossover : CrossoverBase
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="CutAndSpliceEmasCrossover"/> class.
        /// </summary>
        public CutAndSpliceEmasCrossover()
            : base(2, 2)
        {
            IsOrdered = false;
        }
